...
import imagenetic.algorithm.function.NumberChromosomeCreator;
...
public class NumberGeneticAlgorithm extends GeneticAlgorithm<Integer[]> {
    ...
    public NumberGeneticAlgorithm() {
        super(
                new NumberFitnessFunction(),
                new NumberCriterionFunction(),
                new NumberSelectionOperator(),
                new NumberCrossoverOperator(),
                new NumberMutationOperator(),
                new NumberChromosomeCopier(),
                new NumberChromosomeCreator());
    }
}
